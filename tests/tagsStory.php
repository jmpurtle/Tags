...
Scenario: Creating a Fragment with data
	...
	<?php $fragment = new Magnus\Tags\Fragment('thud', array('foo' => 'bar'), array('wibble' => 'wobble'), array('baz' => 'qux')); ?>
...
Scenario: Overriding initialization time values
	...
	<?php $tag = new Magnus\Tags\Tag('thud', array('foo' => 'bar'), array('wibble' => 'wobble'), array('baz' => 'qux')); ?>
